...
<ul>
  <li class="m1"><span>Zwei Möglichkeiten Dokument zu rendern:</span></li>
  <ul>
    <li><span>Code</span></li>
    <li><span>RStudio GUI</span></li>   
  </ul>
</ul>
...
rmarkdown::render("PFAD/dokument.Rmd")
```
...
<ul>
  <li class="m1"><span>Chunks können entweder manuell oder via RStudio GUI eingefügt werden.</span></li>
</ul>
...
<ul>
  <li class="m1"><span>Mit <b>C</b>ascading <b>S</b>tyle <b>S</b>heets können alle <high>ästhetischen Charakteristika</high> von <high>HTML</high> Dokumenten über eine externe Datei bestimmt werden.</span></li>
...
```{r eval=FALSE, echo=TRUE}
# Inhalt des Skripts "render_rmd.R"
rmarkdown::render("PFAD/Bericht.Rmd")
```

```{bash eval=FALSE, echo=TRUE}
0 7 * * 1-5 usr/R/local/bin/Rscript "PFAD/render_rmd.R"
```
...
<br>
<p align = "center">
  <img src="image/cronR-rstudioaddin.png" width=350px><br>
  <font style="font-size:10px">from <a href="https://github.com/bnosac/cronR">github.com/bnosac/cronR</a></font>
</p>
...
<p align = "center">
  <img src="image/taskscheduleR-rstudioaddin.png" width=400px><br>
  <font style="font-size:10px">from <a href="https://github.com/bnosac/taskscheduleR">github.com/bnosac/taskscheduleR</a></font>
</p>
