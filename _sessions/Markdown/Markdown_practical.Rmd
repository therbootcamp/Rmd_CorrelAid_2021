...
In diesem Practical lernst du einen Bericht mit Markdown zu erstellen. Dazu wirst du zuerst einen .zip Ordner, mit den nötigen Materialien herunterladen (siehe *Aufgaben* Tab). Das Endprodukt ist der `airbnb_bericht_loesung.html` Bericht im `3_Markdown` Ordner diese .zip Ordners.
...
1. Lade den *Mardown_Uebungen.zip* Ordner mit den Inhalten, die für diese Übung wichtig sind [**von hier**](https://github.com/therbootcamp/Rmd_CorrelAid_2021/raw/master/Markdown_Uebungen.zip) herunter und unzippe ihn.
